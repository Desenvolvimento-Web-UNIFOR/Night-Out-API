...
export async function atualizarPropostaArtista(id: string, dados: Partial<PropostaArtistaDTO>) {
    ...
    const propostaArtistaAtualizado = await prisma.propostaArtista.update({
        where: { id_proposta_artista: id },
        data: {
            id_proposta_artista: dados.id_proposta_artista ?? propostaArtistaExistente.id_proposta_artista,
            id_casa: dados.id_casa ?? propostaArtistaExistente.id_casa,
            id_evento: dados.id_evento ?? propostaArtistaExistente.id_evento,
            data_proposta: dados.data_proposta ?? propostaArtistaExistente.data_proposta,
            data_evento: dados.data_evento ?? propostaArtistaExistente.data_evento,
            valor_ofertado: dados.valor_ofertado ?? propostaArtistaExistente.valor_ofertado,
